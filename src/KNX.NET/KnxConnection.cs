...
public abstract class KnxConnection
{
    ...
    /// </summary>
    public readonly KnxConnected KnxConnectedDelegate = null;
    ...
    /// </summary>
    public readonly KnxDisconnected KnxDisconnectedDelegate = null;
    ...
    /// </summary>
    public readonly KnxEvent KnxEventDelegate = (address, state) => { };
    ...
    /// </summary>
    public readonly KnxStatus KnxStatusDelegate = (address, state) => { };
